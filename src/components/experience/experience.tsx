...
export default async function Experience() {
  ...
  const titleStyles =
    "text-xl font-semibold text-gray-800 text-center md:text-left";
  const techStyles =
  ...
  return (
    <section className="flex container mx-auto flex-col gap-5 px-5 xl:px-0 xl:max-w-[1200px]" id="experience">
      <h1 className="text-3xl font-semibold text-gray-800 text-center lg:text-left">
        Experience
      </h1>
      <h2 className="text-xl font-semibold text-gray-600 text-center md:text-left">

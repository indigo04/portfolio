export async function Navigation() {
    const linkStyles = 'py-2 px-8 lg:p-2 font-semibold text-xl lg:text-2xl text-gray-800 cursor-pointer hover:scale-125 duration-500'
    return (
        <nav className="flex justify-end" aria-label="Main navigation">
            <ul className="flex lg:pr-24 gap-2 lg:gap-5 pt-3 flex-wrap justify-between">

...
export default async function Contact() {
  ...
  return (
    <section
      className="flex container mx-auto border-2 border-black rounded-t-3xl p-4 justify-between items-center flex-wrap flex-col lg:flex-row gap-2 lg:gap-0 xl:max-w-[1200px]"
      id="contact"
    >
